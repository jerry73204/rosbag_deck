...
typedef void (*rosbag_deck_status_callback_t)(
    const rosbag_deck_status_t *status, void *user_data);
typedef void (*rosbag_deck_message_callback_t)(
    const rosbag_deck_message_t *message, void *user_data);
